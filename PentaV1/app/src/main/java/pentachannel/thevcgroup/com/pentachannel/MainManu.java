...
public class MainManu extends Activity
    ...
    Fragment NavFragment = new NavigationDrawerFragment();
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        fragmentManager.beginTransaction()
                .replace(R.id.container, TagPageFragment)
                .commit();
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_mainmanu, container, false);
            return rootView;
        }
        ...
        public void onAttach(Activity activity) {
            ...
            ((MainManu) activity).onSectionAttached(
                    getArguments().getInt(ARG_SECTION_NUMBER));
        }
    }
    public void onSendText(String tag)
    {
        TagPageFragment.getTagFromNav(tag);
    }

    public void onSendChannelName(String ChannelName)
    {
        mTitle = ChannelName;
    }
}
